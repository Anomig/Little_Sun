...
class HubManager
{
    ...
    public function addManager($firstname, $lastname, $email, $password, $function, $hub_location, $task_id)
    {
        ...
        $stmt = $this->pdo->prepare($sql);
            $stmt->execute([$firstname, $lastname, $email, $hashed_password, 'manager', $hub_location, NULL]);
    }
